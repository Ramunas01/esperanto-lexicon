"""Esperanto morphological decomposer — self-contained, dependency-free.

Canonical implementation. ``eolex_relevance`` re-imports from here.

The algorithm: Rule 1 solid-root short-circuit, Rule 2 function word, Rule 3
prefix/suffix/compound enumeration, Rule 4 selection key (fewest morphemes,
then lowest worst-tier-rank, then longest leading root).
"""
...
class Decomposition:
    ...
    def roots(self) -> tuple[str, ...]:
        """Content-root strings in position order."""
